...
func Open(ctx context.Context, path string) (*Store, error) {
	...
	// Display-title projections are maintained at write time. Existing rows
	// receive the same canonical derivation before any read, including the
	// language-independent generated-fallback discriminator.
